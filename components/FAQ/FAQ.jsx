  ...
  return (
    <div className="max-w-3xl mx-auto gap-10" id="faqs">
      ...
      <div className="mx-auto rounded-2xl transition-all delay-100 ease-in my-12">
        <DisclosureComponent
          heading={"Where and how to register for Hack The Verse '23?"}
        >
        ...
        <DisclosureComponent
          heading={"Can students outside CMRTC participate in Hack The Verse '23?"}
        >
          <p>
        ...
        <DisclosureComponent
          heading={
            "Are there any solo events under Hack The Verse '23 or do I need to team up?"
          }
        >
          <p>
        ...
        <DisclosureComponent
          heading={
            "Can Hack The Verse '23 environment allow us to code in any language or will there be an IDE and  DB provided to us?"
          }
        >
          <p>
